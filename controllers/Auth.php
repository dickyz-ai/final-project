...
class Auth extends CI_Controller
{
    ...
    //fungsi registrasinya
    public function regist()
    {
        $this->form_validation->set_rules('name', 'Name', 'required|trim|is_unique[user.name]', ['is_unique' => 'This username has already registered!']);
    ...
    //fungsi block user jika ingin masuk halaman admin
